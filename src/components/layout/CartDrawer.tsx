...
export function CartDrawer() {
  ...
  return (
    <div className="fixed inset-0 z-[70]">
      ...
      />
      <div 
        className="absolute right-0 top-0 flex flex-col bg-ink-900 border-l border-b border-ink-800/80 animate-slide-in-right cart-drawer-container w-full max-w-[280px] md:max-w-[360px]"
